...
import (
	...
	"serverM/config"
	"serverM/handle/admin"
	"serverM/handle/agent/getscript"
	"serverM/handle/agent/install"
	pt "serverM/handle/agent/port"
	"serverM/handle/agent/threshold"
	"serverM/handle/company"
	e "serverM/handle/email"
	"serverM/handle/monitor" // 引入 monitor 包
	"serverM/handle/notice"
	"serverM/handle/transfer"
	g "serverM/handle/transfer/global"
	trans "serverM/handle/transfer/trans-init"
	"serverM/handle/user/info"
	"serverM/handle/user/login"
	"serverM/handle/user/update"
	"serverM/logs"
	"serverM/middlewire"
	"serverM/middlewire/cors"
	db "serverM/model/init"
	"serverM/redis"
...
func SetupRouter() *gin.Engine {
	...
	router.GET("/debug/pprof/*action", func(c *gin.Context) {
